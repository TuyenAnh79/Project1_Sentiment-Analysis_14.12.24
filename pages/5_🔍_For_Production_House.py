...
# Load data
san_pham = pd.read_csv('data/San_pham.csv')
danh_gia= pd.read_csv('data/Danh_gia.csv')
khach_hang= pd.read_csv('data/Khach_hang.csv')
san_pham_image_brand_link = pd.read_csv('files_nam/San_pham_Link_Image_Brand.csv')

################ START_ Tien xu ly cot noi_dung_binh_luan #####################

#LOAD EMOJICON
file = open('files_nam/emojicon.txt', 'r', encoding="utf8")
...
#################
#LOAD TEENCODE
file = open('files_nam/teencode.txt', 'r', encoding="utf8")
...
with open("files_nam/teencode.txt", 'r', encoding='utf-8') as file:
    for line in file:
...
file = open('files_nam/english-vnmese.txt', 'r', encoding="utf8")
...
################
#LOAD wrong words
file = open('files_nam/wrong-word.txt', 'r', encoding="utf8")
wrong_lst = file.read().split('\n')
file.close()
#################
#LOAD STOPWORDS
file = open('files_nam/vietnamese-stopwords.txt', 'r', encoding="utf8")
...
def analyze_comments(df: pl.DataFrame) -> pl.DataFrame:
    ...
    san_pham_kw = load_keywords('files_nam/san_pham_keywords.txt')
    dich_vu_kw = load_keywords('files_nam/dich_vu_keywords.txt')
    giao_hang_kw = load_keywords('files_nam/giao_hang_keywords.txt')

    with open('files_nam/vietnamese-stopwords.txt', 'r', encoding='utf-8') as file:
...
def display_rating_tabs(filtered_comments):
    ...
    keywords = {category: load_keywords(f'files_nam/{category}_keywords.txt') for category in categories_display.keys()}
...
def plot_product_comments_wordcloud(df, product_id, stopwords=None):
    ...
    try:
        with open("files_nam/positive_words.txt", 'r', encoding='utf-8') as f:
            positive_words = f.read().splitlines()
        
        with open("files_nam/negative_words.txt", 'r', encoding='utf-8') as f:
        ...
        with open("files_nam/vietnamese-stopwords.txt", 'r', encoding='utf-8') as f:
