...
output_file = 'data/model_results.json'
...
#             ## Với mục tiêu kiểm soát Negative để cải thiện chất lượng phục vụ, nên tôi chọn Model LOGICTIC REGRESSION vì có số lượng Negative bị sai ít nhất""")

st.markdown(
    """
    ## Dựa số liệu ở trên, chọn model LOGISTIC REGRESSION
    ### Với mục tiêu kiểm soát Negative để cải thiện chất lượng phục vụ, nên tôi chọn Model này
    ### Vì có số lượng Negative bị sai ít nhất
"""
)